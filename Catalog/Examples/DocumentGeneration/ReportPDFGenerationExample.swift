...
final class ReportPDFGenerationExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        let quickStartDocument = AssetLoader.document(for: .quickStart)
        let quickStartTemplate = PageTemplate(document: quickStartDocument, sourcePageIndex: 7)
        configuration.addNewPage(at: 3, configuration: PDFNewPageConfiguration(pageTemplate: quickStartTemplate, builderBlock: nil))
